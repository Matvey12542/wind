 ...
 */
class Version20141208143019 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Generator CHANGE path logo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Generator CHANGE logo path VARCHAR(255) DEFAULT NULL');
    }
}
